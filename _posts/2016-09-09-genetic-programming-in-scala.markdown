...
The snippets (those without file names) below should work in the SBT console of the project (or an IntelliJ worksheet). The project is available in my GitHub repository: [mattroberts297/genetic-programming-in-scala](http://github.com/mattroberts297/genetic-programming-in-scala).
...
<amp-img
  src="//assets.mattroberts.io/img/SecondDegreePolynomial.png"
  alt="Second degree polynomial"
  layout="responsive"
  height="639"
  width="849">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/ThirdDegreePolynomial.png"
  alt="Third degree polynomial"
  layout="responsive"
  height="639"
  width="836">
</amp-img>
...
<amp-img
  src="https://assets.mattroberts.io/img/FullTrees.png"
  alt="Full trees"
  layout="responsive"
  height="871"
  width="1347">
...
<amp-img
  src="https://assets.mattroberts.io/img/GrowTrees.png"
  alt="Grow trees"
  layout="responsive"
  height="871"
  width="1468">
...
<amp-img
  src="//assets.mattroberts.io/img/SecondDegreePolynomialRun1.png"
  alt="Second degree polynomial run 1"
  layout="responsive"
  height="670"
  width="848">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/SecondDegreePolynomialRun2.png"
  alt="Second degree polynomial run 2"
  layout="responsive"
  height="670"
  width="848">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/SecondDegreePolynomialRun3.png"
  alt="Second degree polynomial run 3"
  layout="responsive"
  height="670"
  width="861">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/SecondDegreePolynomialRun4.png"
  alt="Second degree polynomial run 4"
  layout="responsive"
  height="670"
  width="861">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/SecondDegreePolynomialRun5.png"
  alt="Second degree polynomial run 5"
  layout="responsive"
  height="670"
  width="848">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/ThirdDegreePolynomialRun1.png"
  alt="Third degree polynomial run 1"
  layout="responsive"
  height="670"
  width="836">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/ThirdDegreePolynomialRun3.png"
  alt="Third degree polynomial run 3"
  layout="responsive"
  height="670"
  width="836">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/ThirdDegreePolynomialRun5.png"
  alt="Third degree polynomial run 5"
  layout="responsive"
  height="670"
  width="836">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/ThirdDegreePolynomialRun8.png"
  alt="Third degree polynomial run 8"
  layout="responsive"
  height="670"
  width="836">
</amp-img>
...
<amp-img
  src="//assets.mattroberts.io/img/ThirdDegreePolynomialRun10.png"
  alt="Third degree polynomial run 10"
  layout="responsive"
  height="670"
  width="836">
</amp-img>
...
Genetic programming seems like a brilliant way to search a constrained space for an optimum or approximate solution to some problem. Don't forget the full source is available on GitHub at [mattroberts297/genetic-programming-in-scala](http://github.com/mattroberts297/genetic-programming-in-scala). If there is interest then I'll do a follow up post showing how to run this on a Spark cluster.
